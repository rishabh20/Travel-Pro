...
namespace Experiment
{
    ...
    public sealed partial class Page1 : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            // string retr = player.Source.Uri.ToString();
            // player.Source = new Uri(retr,UriKind.Absolute);
            // player.Play();
        ...
        private void CountryGuide_Click(object sender, RoutedEventArgs e)
        {
        ...
        private async void Translator_Tapped(object sender, TappedRoutedEventArgs e)
        {
            Frame.Navigate(typeof(Translator));
        ...
        private void CountryGuide_Tapped(object sender, TappedRoutedEventArgs e)
        {
            Frame.Navigate(typeof(CountryInfo));
        }
