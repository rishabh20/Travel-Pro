...
namespace Experiment
{
    ...
    /// </summary>
    public sealed partial class A7 : Page
    {
        ...
        private void Third_Tapped(object sender, TappedRoutedEventArgs e)
        {
            Frame.Navigate(typeof(A74));
        }

        private void Fourth_Tapped(object sender, TappedRoutedEventArgs e)
        {
            Frame.Navigate(typeof(A73));
        }

        private void Second_Tapped(object sender, TappedRoutedEventArgs e)
        {
            Frame.Navigate(typeof(A72));
        }

        private void First_Tapped(object sender, TappedRoutedEventArgs e)
        {
            Frame.Navigate(typeof(A71));
        }
    }
}
