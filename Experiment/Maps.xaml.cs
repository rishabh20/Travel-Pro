...
namespace Experiment
{
    ...
    public sealed partial class Maps : Page
    {
        ...
        private async void Mapsbtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                uritolaunch = @"bingmaps:?cp=" + latitude + "~" + longitude + "&lvl=9" +"&q=" +Textbox.Text;
                var uri = new Uri(uritolaunch);
                Windows.System.Launcher.LaunchUriAsync(uri);
            }
            catch (Exception ex)
            {
                //MessageBox("Speech recognition not enabled. Do so by going to Settings=>Speech=>Enable Speech Recognition");
            }
